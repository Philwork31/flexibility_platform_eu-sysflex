...
class BidGridImpactAssessmentResult(viewsets.ModelViewSet):
    queryset = BiddingGridImpactAssessmentResult.objects.order_by("-id")
    serializer_class = BidGridImpactAssessmentResultSerializer