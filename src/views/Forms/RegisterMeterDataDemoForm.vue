    ...
    <div class="view-content">
        ...
        <form class="fp-view-form" @submit.prevent="submit()">
            <div class="form-header">
                <h2>Register a metering data</h2>
            </div>
                        ...
                        <div class="dp_energy_fields_flex">
                            <div class="start_of_dp_field fp-field">
                                ...
                                <div class="start_of_delivery_name_field_datetimepicker">
                                    <VueCtkDateTimePicker v-bind:id="'serviceDateStart' + n" v-model="serviceDateStart[n-1]" label="Date" onlyDate="True" format="YYYY-MM-DD" formatted="ll"></VueCtkDateTimePicker>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      this.$axios.post(location.protocol + "//" + location.hostname+(location.port ? ":" + location.port: "") + "/api/v1/registermeteringdata/", formData,
		{
			headers: {
