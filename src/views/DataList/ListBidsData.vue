                    ...
                    <div class="tablerowwrapper">
                        <div class="tablerowwrapper-left">
                            ...
                            <div class="tablerowwrapperdetails" v-bind:class="{ nighttheme: $route.params.theme == 'n' }">
                                <div>Details : Price {{ json.price }}, Power {{ json.power_constraint_by_grid }} ...</div>
                            </div>
                        </div>
...
export default {
    ...
    mounted() {
        var self = this;
        this.$axios
            .get(location.protocol + "//" + location.hostname+(location.port ? ":" + location.port: "") + '/api/v1/bids/?format=json')
